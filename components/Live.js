...
export default class Live extends React.Component {
    ...
    componentDidMount () {
        ...
        .catch((error) => {
            console.warn('Error gettin Location permission', error)
    ...
    askPermission = () => {
        ...
        .catch((error) =>
            console.warn('error askin Location permisssion', error)
        )
    }
    setLocation = () => {
        ...
        if (status === 'denied') {
            return (
                <View style={styles.center}>
                    ...
                    <Text>You denied your location. You can fix this by...</Text>
                </View>
            )
        }
